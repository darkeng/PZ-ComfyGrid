...
Events.OnGameBoot.Add(function()
    ...
    local function bookkeepTransfer(action, item)

        local moved = action.item or item
        ...
        if destIsFloor then
            if moved:getContainer() == action.srcContainer then return end
    ...
    function ISInventoryTransferAction:transferItem(item)
        ...
        ok, err = pcall(bookkeepTransfer, self, item)
