...
- **Auto-stacking** — identical items merge into one tile whatever their state (fresh and stale food, a pristine and a worn axe); a colour bar shows each tile's status, and an option restores strict grouping by state.
